...
{
    public function __construct() {
        parent::__construct('alvi_maps', 'AlviMaps', array('description' => 'blabla'));
    }
    ...
    public function widget($args, $instance) {
	    ...
	    ?>
	        <p>
	            ...
	            <input id="alvi_origin" name="alvi_origin" type="text" value="<?php echo $origin; ?>" onkeypress="if(event.keyCode==13) {codeAddress(); event.preventDefault()}"/>
	            <label for="alvi_destination">Arrivée :</label>
	            <input id="alvi_destination" name="alvi_destination" type="text" value="<?php echo $destination; ?>" onkeypress="if(event.keyCode==13) {codeAddress(); event.preventDefault()}" />
				...
				distance.getDistanceMatrix(
			  	{
					...
					if (status != google.maps.DistanceMatrixStatus.OK)
						document.getElementById('alvi_distance').innerHTML = "Aucun itinéraire possible";
					else {
